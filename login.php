...
if(isset($_POST['tombol'])){
    ...
    if($cek > 0){
        // //login berhasil
        // $pesan = ' <div class="alert alert-success" role="alert"> <i class="fa-regular fa-thumbs-up"></i> LOGIN BERHASIL, JANGAN COBA LAGI!!! </div>' ;
        ...
        //login gagal
        $pesan = '<div class="alert alert-danger" role="alert"> <i class="fa-solid fa-radiation"></i> LOGIN GAGAL, COBA LAGI!!!</div>' ;
    }
}
?>
